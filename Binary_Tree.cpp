...
int Sum_node(TREE &t, int &count){
    if (t != NULL){
        count++;
        Sum_node(t->pLeft, count);
        Sum_node(t->pRight, count);
    }
    return count;
}
...
void Menu(TREE &t){
    ...
    while (true)
    {
        ...
        cout << "..........................MENU..........................\n";
        cout << " ==> 1.  Add Element\n";
        cout << " ==> 2.  Display the list on screen (Root - Left - Right) - Preorder \n";
        cout << " ==> 3.  Display the list on screen (Root - Right - Left)\n";
        cout << " ==> 4.  Display the list on screen (Left - Root - Right) - Inorder \n";
        cout << " ==> 5.  Display the list on screen (Right - Root - Left) \n";
        cout << " ==> 6.  Display the list on screen (Left - Right - Root) - Postorder\n";
